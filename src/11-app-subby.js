...
function SubbyApp(_ref) {
  ...
  var ICONE_KEYWORDS = [['netflix', '🎬'], ['disney', '📺'], ['prime video', '🎥'], ['amazon prime', '🎥'], ['hbo', '🎥'], ['twitch', '🟣'], ['spotify', '🎵'], ['apple music', '🎧'], ['deezer', '📻'], ['youtube', '▶️'], ['microsoft', '💻'], ['office', '💻'], ['icloud', '☁️'], ['google one', '☁️'], ['dropbox', '☁️'], ['chatgpt', '🤖'], ['claude', '🤖'], ['openai', '🤖'], ['notion', '📝'], ['adobe', '🎨'], ['canva', '🎨'], ['vpn', '🔐'], ['nordvpn', '🔐'], ['password', '🔐'], ['electr', '💡'], ['strom', '💡'], ['eletric', '💡'], ['agua', '💧'], ['wasser', '💧'], ['gas', '🔥'], ['internet', '📡'], ['swisscom', '📡'], ['sunrise', '📡'], ['salt', '📡'], ['upc', '📡'], ['digital republik', '📡'], ['gagnet', '📡'], ['apple', '🍎'], ['meo', '📱'], ['nos', '📱'], ['vodafone', '📱'], ['telemovel', '📱'], ['mobile', '📱'], ['renda', '🏠'], ['seguro casa', '🏠'], ['hausrat', '🏠'], ['ginasio', '🏋️'], ['gym', '🏋️'], ['fitness', '🏋️'], ['saude', '🩺'], ['krankenkasse', '🩺'], ['seguro saude', '🩺'], ['farmacia', '💊'], ['suplemento', '💊'], ['yoga', '🧘'], ['meditat', '🧘'], ['headspace', '🧘'], ['calm', '🧘'], ['seguro carro', '🚗'], ['auto', '🚗'], ['carro', '🚗'], ['combustivel', '⛽'], ['carregamento', '⛽'], ['transporte', '🚌'], ['sbb', '🚌'], ['passe', '🚌'], ['parking', '🅿️'], ['parque', '🅿️'], ['xbox', '🎮'], ['playstation', '🎮'], ['nintendo', '🎮'], ['steam', '🎮'], ['jornal', '📰'], ['revista', '📰'], ['curso', '🎓'], ['formacao', '🎓'], ['udemy', '🎓'], ['escola', '🎓'], ['creche', '👶'], ['animal', '🐶'], ['pet', '🐶']];
  var detectarIcone = function detectarIcone(nome) {
    var n = nome.toLowerCase();
    for (var i = 0; i < ICONE_KEYWORDS.length; i++) {
      if (n.indexOf(ICONE_KEYWORDS[i][0]) !== -1) return ICONE_KEYWORDS[i][1];
    }
    return null;
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    value: form.nome,
    onChange: function (e) {
      var novoNome = e.target.value;
      var sugestao = !form.iconeManual ? detectarIcone(novoNome) : null;
      setForm(Object.assign({}, form, {
        nome: novoNome
      }, sugestao ? {
        icone: sugestao
