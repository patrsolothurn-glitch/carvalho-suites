...
var HV_CSS = '' +
  ...
  '.hv-cal-cabecalho{display:grid;grid-template-columns:28px repeat(7,1fr);gap:4px;padding:0 2px}' +
  '.hv-cal-cabecalho span{font-size:12px;font-weight:800;color:var(--hv-texto2);text-align:center;text-transform:uppercase}' +
  '.hv-cal-grid{display:grid;grid-template-columns:28px repeat(7,1fr);gap:4px;grid-auto-rows:minmax(96px,auto)}' +
  '.hv-cal-kw{font-size:13px;color:var(--hv-texto2);text-align:center;padding-top:6px;cursor:pointer;align-self:start}' +
  '.hv-cal-vazia{min-height:96px}' +
  '.hv-cal-celula{min-height:96px;border-radius:10px;background:var(--hv-cartao);border:2px solid var(--hv-borda);padding:3px;display:flex;flex-direction:column;gap:3px;cursor:pointer;overflow:visible;position:relative;z-index:1}' +
  '.hv-cal-celula:focus,.hv-cal-celula:hover{z-index:2}' +
  ...
  '.hv-cal-celula.hv-cal-sel{border-width:3px;border-color:var(--hv-principal)}' +
  '.hv-cal-numero{font-size:18px;font-weight:800;color:var(--hv-texto);line-height:1}' +
  '.hv-cal-numero-dom{color:var(--hv-negativo)}' +
  '.hv-cal-numero-hoje{width:26px;height:26px;border-radius:50%;background:var(--hv-principal);color:var(--hv-principal-texto);display:flex;align-items:center;justify-content:center;font-size:14px}' +
  '.hv-cal-etiqueta{border-radius:6px;padding:2px 2px;color:#fff;text-align:center;white-space:nowrap;overflow:visible;font-variant-numeric:tabular-nums;font-weight:800}' +
  '.hv-cal-etiqueta-extra{border-radius:6px;padding:2px 2px;text-align:center;white-space:nowrap;overflow:visible;font-variant-numeric:tabular-nums;font-weight:800}' +
  '.hv-cal-livre-bloco{border-radius:8px;background:var(--hv-tipo-livre-bg);color:var(--hv-tipo-livre-fg);font-size:11px;text-align:center;padding:5px 2px;flex:1;display:flex;align-items:center;justify-content:center}' +
  '.hv-cal-registar{border:1.5px dashed var(--hv-principal);border-radius:6px;color:var(--hv-principal);font-size:11px;text-align:center;padding:4px 2px}' +
  '.hv-cal-meta-futuro{font-size:11px;color:var(--hv-texto2)}' +
...
function HorasVozApp(props) {
  ...
  var _s45 = React.useState(null); var diaCalSelecionado = _s45[0], setDiaCalSelecionado = _s45[1]; // dateStr selecionado na grelha
  ...
  function renderMesCalendario(y, m) {
    ...
    grelha.forEach(function (semana) {
      celulasGrid.push(React.createElement('span', { key: 'kw' + semana.segunda, className: 'hv-cal-kw', 'data-kw-monday': semana.segunda }, 'KW ' + semana.kw));
    ...
    return React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 10, position: 'relative' } },
      React.createElement(HvCard, { style: { background: 'var(--hv-fundo)' } },
