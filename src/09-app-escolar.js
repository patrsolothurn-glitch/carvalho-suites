...
function EscolarApp(_ref31) {
  ...
  var _useStateNotaInputs = (0, _react.useState)({}),
    _useStateNotaInputs2 = _slicedToArray(_useStateNotaInputs, 2),
    notaInputs = _useStateNotaInputs2[0],
    setNotaInputs = _useStateNotaInputs2[1];
    ...
    Promise.all([sb.from('escolar_disciplinas').select('*'), sb.from('escolar_horario').select('*'), sb.from('escolar_notas').select('*'), sb.from('escolar_tpc').select('*'), sb.from('escolar_perfil').select('*'), sb.from('escolar_eventos').select('*')]).then(function (resArr) {
      ...
      setAlunosData(function (prev) {
        ...
        Object.keys(next).forEach(function (key) {
          ...
          var perfilRow = (perfilRes.data || []).find(function (r) {
            return r.aluno === key;
          });
          if (perfilRow) {
            if (perfilRow.klasse) updated.klasse = perfilRow.klasse;
            if (perfilRow.cidade) updated.cidade = perfilRow.cidade;
            updated.responsavel = {
              nome: perfilRow.resp_nome || '',
              sala: perfilRow.resp_sala || '',
              tel: perfilRow.resp_tel || '',
              email: perfilRow.resp_email || ''
            };
          }
          next[key] = updated;
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83D\uDCDA Vida Escolar")), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    }, "\u270E")), isSel && al.responsavel && al.responsavel.nome && /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: 9.5,
        color: E.muted,
        whiteSpace: 'normal',
    ...
    }, "\uD83D\uDC69\u200D\uD83C\uDFEB ", al.responsavel.nome, al.responsavel.sala ? " \xB7 sala ".concat(al.responsavel.sala) : '', al.responsavel.tel ? " \xB7 ".concat(al.responsavel.tel) : '')), isSel && /*#__PURE__*/React.createElement("div", {
      style: {
        width: 7,
        height: 7,
        borderRadius: '50%',
 ...
 /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(ECard, {
      ...
      onClick: function onClick() {
        ...
        setNotaInputs(function (prev) {
          return _objectSpread(_objectSpread({}, prev), {}, _defineProperty({}, t.id, ''));
        });
