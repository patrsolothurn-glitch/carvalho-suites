function NutriguimaApp(_ref29) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: { background: N.surface, borderRadius: '20px 20px 0 0', padding: '20px 16px 36px', maxHeight: '90vh', overflowY: 'auto' }
  },
    ...
    cartItems.filter(function(p) { return (stock[p.id] || 0) > 0; }).length > 0 && /*#__PURE__*/React.createElement("div", { style: { marginBottom: 16 } },
      ...
      cartItems.filter(function(p) { return (stock[p.id] || 0) > 0; }).map(function(p) {
        var qty = cart[p.id] || 0;
        return /*#__PURE__*/React.createElement("div", { key: p.id, style: { display: 'flex', alignItems: 'center', gap: 10, padding: '9px 0', borderBottom: "1px solid " + N.border } },
          ...
          /*#__PURE__*/React.createElement("p", { style: { fontWeight: 800, color: N.gold, fontSize: 14 } }, "\u20AC" + (qty * p.price).toFixed(2))
        );
      }),
      /*#__PURE__*/React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', padding: '10px 0 4px' } },
        /*#__PURE__*/React.createElement("span", { style: { fontWeight: 800 } }, "Total"),
        /*#__PURE__*/React.createElement("span", { style: { fontWeight: 800, color: N.gold } }, "\u20AC" + cartItems.filter(function(p){ return (stock[p.id]||0)>0; }).reduce(function(s,p){ return s+(cart[p.id]||0)*p.price; },0).toFixed(2))
      ),
    ...
    cartItems.filter(function(p) { return (stock[p.id] || 0) === 0; }).length > 0 && /*#__PURE__*/React.createElement("div", { style: { marginTop: 8 } },
      /*#__PURE__*/React.createElement("p", { style: { color: N.muted, fontSize: 11, fontWeight: 700, textTransform: 'uppercase', marginBottom: 8 } }, "\uD83D\uDED2 Pedir via Zumub (sem stock local)"),
      cartItems.filter(function(p) { return (stock[p.id] || 0) === 0; }).map(function(p) {
        var qty = cart[p.id] || 0;
        return /*#__PURE__*/React.createElement("div", { key: p.id, style: { display: 'flex', alignItems: 'center', gap: 10, padding: '9px 0', borderBottom: "1px solid " + N.border } },
          /*#__PURE__*/React.createElement("span", { style: { fontSize: 20 } }, p.emoji),
          /*#__PURE__*/React.createElement("div", { style: { flex: 1 } },
            /*#__PURE__*/React.createElement("p", { style: { fontWeight: 700, fontSize: 13 } }, p.name),
            /*#__PURE__*/React.createElement("p", { style: { color: N.muted, fontSize: 11 } }, qty + " un. \u2014 sem stock local")
          ),
          /*#__PURE__*/React.createElement("a", {
            href: "https://www.zumub.com/pt/pesquisa?q=" + encodeURIComponent(p.name),
            target: "_blank", rel: "noreferrer",
            style: { background: "linear-gradient(135deg," + N.gold + "," + N.goldL + ")", borderRadius: 8, padding: '6px 10px', color: N.bg, fontSize: 11, fontWeight: 800, textDecoration: 'none' }
          }, "Zumub \u2192")
        );
      }),
      /*#__PURE__*/React.createElement("a", {
        href: "http://zumu.be/eb762cd1", target: "_blank", rel: "noreferrer",
        style: { display: 'block', background: "linear-gradient(135deg," + N.gold + "," + N.goldL + ")", borderRadius: 13, padding: '13px', color: N.bg, fontSize: 14, fontWeight: 800, textDecoration: 'none', textAlign: 'center', marginTop: 12 }
      }, "\uD83D\uDED2 Abrir Zumub com 10% desconto \u2192")
    )
  )), /*#__PURE__*/React.createElement("div", {
    style: {
