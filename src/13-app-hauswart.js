      ...
      React.createElement('button', {
        onClick: function() {
          ...
          var html = '<!DOCTYPE html><html><head><title>Zahlteil ' + referenz + '</title>'
            ...
            + '.zahlteil-wrap { width: 794px; background: white; }'
            ...
            + '  .zahlteil-wrap { width: 100% !important; transform: none !important; }'
            + '  * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }'
            + '}'
            + '@media screen {'
            + '  body { background: #0f172a; }'
            + '  .print-spacer { display: none; }'
            + '  .zahlteil-outer { padding: 8px; }'
            + '}'
            + '</style>'
            + '<script>'
            + '(function() {'
            + '  function fit() {'
            + '    var wrap = document.getElementById("zw");'
            + '    if (!wrap) return;'
            ...
            + '    wrap.style.marginBottom = ((wrap.offsetHeight * s) - wrap.offsetHeight) + "px";'
            + '  }'
