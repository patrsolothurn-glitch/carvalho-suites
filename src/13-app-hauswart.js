...
function HwPrintView(props) {
  ...
  return React.createElement('div', { className: 'hw-print-outer', style: { background: '#94a3b8' } },
    ...
    React.createElement('style', null,
      ...
      '  #print-page { width: 100% !important; min-height: 0 !important; box-shadow: none !important; box-sizing: border-box !important; }' +
      '  .hw-zahlteil-print { display: block !important; background: white !important; }' +
      '  #zahlteil-page { page-break-before: always; break-before: always; width: 100%; height: 297mm; display: flex; flex-direction: column; justify-content: flex-end; background: white; }' +
